...
tests/test_game_logic.py::test_hint_messages_point_toward_secret PASSED  [ 33%]
tests/test_game_logic.py::test_hard_is_harder_than_normal PASSED         [ 41%]
tests/test_game_logic.py::test_first_attempt_win_scores_100 PASSED       [ 50%]
tests/test_game_logic.py::test_parse_guess_rejects_empty_and_non_numeric PASSED [ 58%]
tests/test_game_logic.py::test_parse_guess_truncates_decimals PASSED     [ 66%]
tests/test_game_logic.py::test_win_score_never_drops_below_floor PASSED  [ 75%]
tests/test_game_logic.py::test_negative_number_is_handled PASSED         [ 83%]
tests/test_game_logic.py::test_extremely_large_number_is_handled PASSED  [ 91%]
tests/test_game_logic.py::test_whitespace_padded_number_is_handled PASSED [100%]
